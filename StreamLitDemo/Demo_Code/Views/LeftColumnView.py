...
class LeftColumnView:
    ...
    def __init__(self, st_module, configparser):
        ...
        if "static_template_queries" in st_module.session_state:
            self.dogs_data_original = st_module.session_state.static_template_queries 
        else:
            self.dogs_data_original = st_module.session_state.default_results
